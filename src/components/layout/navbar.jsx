...
export function Navbar() {
  return <nav className="sticky top-0 z-50 w-full bg-background/90 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          variant: "default"
        }), "bg-[#22C55E] hover:bg-[#16A34A] text-white rounded-full font-medium")}>
            Get Started
          </Link>
        </div>
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              ...
              <div className="flex flex-col gap-6 mt-8">
                ...
                <SheetClose render={<Link href="/signup" className={cn(buttonVariants({
                variant: "default"
              }), "bg-[#22C55E] hover:bg-[#16A34A] text-white rounded-full w-full font-medium")} />}>
                  Get Started
                </SheetClose>
              </div>
            </SheetContent>
