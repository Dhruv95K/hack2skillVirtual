...
export function Co2Preview({
  ...
  return <div className="mt-4 p-4 rounded-lg bg-slate-50 dark:bg-slate-900/50 border flex items-center justify-between transition-colors">
