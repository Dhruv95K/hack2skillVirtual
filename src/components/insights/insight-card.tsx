...
const CATEGORY_META: Record<
  AiTip['category'],
  { icon: typeof Car; label: string; iconClassName: string; accentClassName: string }
> = {
  transport: {
    icon: Car,
    label: 'Transport',
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <Badge
                  variant="outline"
                  className={`border px-2 py-1 text-[11px] font-semibold tracking-wide uppercase ${meta.accentClassName}`}
                >
                  {meta.label}
                </Badge>
