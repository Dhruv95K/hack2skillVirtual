...
export function Hero() {
  ...
  return <section className="relative overflow-hidden pt-24 pb-32 md:pt-32 md:pb-40 bg-background text-center">
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden text-[#22C55E]/10">
        ...
        repeatType: "reverse",
        ease: "easeInOut"
      }} viewBox="0 0 1440 320" className="absolute bottom-0 w-full h-auto" preserveAspectRatio="none" aria-hidden="true">
          <path fill="currentColor" d="M0,160L48,176C96,192,192,224,288,208C384,192,480,128,576,133.3C672,139,768,213,864,229.3C960,245,1056,203,1152,181.3C1248,160,1344,160,1392,160L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" />
        </motion.svg>
        <motion.svg initial={{
        opacity: 0,
      ...
      }} className="absolute -top-10 -left-10 w-64 h-64 text-[#16A34A]/20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col items-center">
        ...
        duration: shouldReduceMotion ? 0 : 0.5
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            size: "lg"
          }), "bg-[#22C55E] hover:bg-[#16A34A] text-white rounded-2xl h-14 px-8 text-lg w-full sm:w-auto font-medium")}>
              Start for Free <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
            <Link href="#features" className={cn(buttonVariants({
            variant: "ghost",
            size: "lg"
          }), "rounded-2xl h-14 px-8 text-lg w-full sm:w-auto font-medium hover:text-[#22C55E]")}>
