...
export const metadata = {
  ...
  description: 'Answer a few quick questions so EcoTrack can estimate your baseline footprint and personalize your dashboard.'
};
const STEP_SUMMARY = [{
  icon: CarFront,
  title: 'Transport',
...
export default async function QuizPage() {
  ...
  const isE2EQuizComplete = isE2EAuthBypassEnabled && cookieStore.has('e2e-quiz-complete');
  ...
  return <main className="min-h-screen bg-background px-4 py-8 md:px-6 md:py-12">
      <div className="mx-auto flex max-w-5xl flex-col gap-8">
        <section className="space-y-5">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            title,
            description
          }) => <div key={title} className="rounded-xl border border-white/10 bg-surface/70 px-4 py-4 backdrop-blur-sm">
