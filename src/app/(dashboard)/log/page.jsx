...
const CategoryIcon = ({
  ...
  switch (category) {
    ...
    case 'food':
      return <Salad className="w-4 h-4 text-emerald-600" />;
    case 'energy':
...
export default function LogActivityPage() {
  ...
  return <div className="container mx-auto py-8 max-w-4xl space-y-8">
      ...
      <Card className="border-emerald-100/50 dark:border-emerald-900/50 shadow-sm mt-8">
        ...
        <CardContent>
          {loading ? <div className="flex justify-center p-8">
            ...
            </div> : error ? <div className="text-center p-8 text-red-500 border-2 border-dashed border-red-200 dark:border-red-900/50 rounded-lg bg-red-50 dark:bg-red-950/20">
              {error}
            </div> : logs.length === 0 ? <div className="text-center p-8 text-muted-foreground border-2 border-dashed rounded-lg">
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody>
                  {logs.map(log => <tr key={log.id} className="border-b dark:border-slate-800 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
