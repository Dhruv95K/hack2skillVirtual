      ...
      <main className="flex-1">
        ...
        <section className="py-24 bg-surface-2">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href="/signup" className={cn(buttonVariants({ size: "lg" }), "bg-[#22C55E] hover:bg-[#16A34A] text-white rounded-2xl h-14 px-10 text-lg font-medium shadow-lg shadow-[#22C55E]/20")}>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-muted-foreground text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link 
              ...
              className="hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm inline-flex items-center gap-1"
